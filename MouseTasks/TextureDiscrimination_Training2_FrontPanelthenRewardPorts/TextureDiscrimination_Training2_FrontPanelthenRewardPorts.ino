...
Training 2: Front panel then left or right ports
*/
...
//        Serial.println(RightIRval);
        ...
        if (Lrewtrig>5 && LeftGLight==1 && TrialInit==1){
          ...
          if (inPort==0){
            ...
            RightGlight=0;
            LeftGLight=1; // will go back to right side next
            trialwrapup(3000);
          }
...
//          }
        ...
        if (Rrewtrig>5 && RightGlight==1 && TrialInit==1){
          ...
          if (inPort==0){
            ...
            LeftGLight=0;
            RightGlight=1; // next trial will go back to left side 
            trialwrapup(3000);
          }
