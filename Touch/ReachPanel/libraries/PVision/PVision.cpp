...
#include "PVision.h"
#include <Wire.h>
//Wire methods have been changed wire Arduino 1.0. 
//See http://blog.makezine.com/2011/12/01/arduino-1-0-is-out-heres-what-you-need-to-know/
...
void PVision::init ()
{
    ...
    Write_2bytes((byte)0x30,(byte)0x01); delay(10);
    Write_2bytes((byte)0x30,(byte)0x08); delay(10);
    Write_2bytes((byte)0x06,(byte)0x90); delay(10);
    Write_2bytes((byte)0x08,(byte)0xC0); delay(10);
    Write_2bytes((byte)0x1A,(byte)0x40); delay(10);
    Write_2bytes((byte)0x33,(byte)0x33); delay(10);
    delay(100);
}
